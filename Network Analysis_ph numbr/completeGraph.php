			...
			var d3Sample = function()
			{
					...
					while($row = mysqli_fetch_array($result))
	  				{
						...
						$Graph2[] =array($row['from_number'] , $row['to_number'] );
						$count++;
			  		}		
					echo "map = ".json_encode($Graph).";\n";
				...
				var colors = [
		         	...
		         	var example = function() {
		            		var graph = d3Sample(),
		                	communities = Viva.Graph.community().slpa(graph, 0, 0.30);
					...
					var groupId = node.communities[0].name % colors.length;
		                	...
		                	var circle = Viva.Graph.svg('circle')
		                	    ...
		                	    .attr("fill", colors[groupId ? groupId + 6 : 5]);
...
<div>
  <!--div align="center">Copyright Flutura<br /-->
</div>
</div>
</body>
</html>
